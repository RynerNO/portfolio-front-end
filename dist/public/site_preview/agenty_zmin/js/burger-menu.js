...
var burger_button = document.querySelector('.burger-button_click');
burger_button.addEventListener('click', show_burgermenu, false);

function show_burgermenu() {
  var nav_menu = document.querySelector('.header__nav-burger');
  var first_block_image = document.querySelector('.first-block__image');
