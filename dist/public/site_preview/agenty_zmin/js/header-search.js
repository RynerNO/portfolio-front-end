...
var search_button = document.querySelector(".search-button-show");
var search_button_cancel = document.querySelector('.search-button-cancel');
var header_nav = document.querySelector('.header__nav_hidden');
var search_input = document.querySelector('.search-input');
var search_results = document.querySelector('.search-results-container');
var search_button_submit = document.querySelector('.search-button-submit');
